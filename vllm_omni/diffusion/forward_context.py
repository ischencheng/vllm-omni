...
class ForwardContext:
    ...
    # Projected direct-VLM conditions; lists preserve variable request lengths.
    direct_condition: torch.Tensor | list[torch.Tensor] | None = None
...
def set_forward_context_direct_condition(direct_condition: torch.Tensor | list[torch.Tensor] | None) -> None:
